...
public interface TweetBusiness {
	 ...
	 * 
	 * @return Map of objects containing the day of the month and the number of
	 *         tweets on that day.
	 */
	public Map<Object, Long> getTweetsByHour();

	/**
	 * Groups and counts the tweets by hour by using the MongoDB aggregation
	 * function.
	 * 
